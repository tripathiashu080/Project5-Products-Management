...
// order api
router.post('/users/:userId/orders',authenticate.authentication,authorize.authorization, orderController.createOrder);
router.put('/users/:userId/orders',authenticate.authentication,authorize.authorization, orderController.updateOrder);
